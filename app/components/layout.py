...
def layout(content: rx.Component) -> rx.Component:
    ...
    return rx.el.div(
        ...
        rx.el.div(
            class_name="fixed top-1/4 left-1/4 w-96 h-96 bg-[#556B2F]/20 rounded-full blur-3xl z-0 animate-pulse"
        ),
        rx.el.div(
            class_name="fixed bottom-1/4 right-1/4 w-96 h-96 bg-[#556B2F]/10 rounded-full blur-3xl z-0 animate-pulse delay-1000"
        ),
        class_name="font-sans antialiased text-slate-100 min-h-screen w-full overflow-hidden relative selection:bg-[#556B2F]/30",
    )